//componete register funcionando perfecto pero sin confirmar email ni token
/* "use client"
  ...
  return (
    <div>
      <RegistrationConfirmationModal 
        ...
        onCloseRegistrationConfirmation = {() => setIsRegistrationModalOpen(false)}
      />
...
const FormRegister = () => {
  ...
  console.log("valor de token en FormRegister.tsx: ", token);
  console.log("valor de email en FormRegister.tsx: ", email);
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        //console.log("Valor de values.email: ", values.email);
        console.log("Valor de values.password: ", values.password);
        // Primero registra al usuario en Firebase
          //const recivedEmail: string | null = email;
          const { user, error: firebaseError } = await registerUserWithFirebase(
            email,
            values.password
          );
