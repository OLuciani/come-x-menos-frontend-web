...
import { createDiscount, Discount } from "@/services/apiCall";
    ...
    <div>
      ...
      >
        ...
        <TextareaAutosize
          id="message"
          name="description"
          placeholder="Haz una descripción detallada de tu oferta de descuento."
          value={formik.values.description}
          onChange={formik.handleChange}
          onBlur={formik.handleBlur}
          rows={4}
          className={
            "border-[2px] border-[#FD7B03] w-full min-h-24 mt-[-10px] p-2"
          }
          required
        />
        ...
        <Input
          ...
          minLength={0}
        />
        {formik.touched.title && formik.errors.discountAmount ? (
    ...
    <div>
      ...
      />
        ...
        <TextareaAutosize
          ...
          onBlur={formik.handleBlur}
          rows={4}
          className="border-[2px] border-[#FD7B03] w-full min-h-24 mt-[-10px] p-2"
          required
        />
