...
<div className="bg-white border-2 shadow-lg rounded-lg p-2 custom-w-450:p-4 lg:py-4 h-full">
        <div className="bg-[#FFCF91] rounded-t-lg">
          <h2 className="text-xl lg:text-2xl font-semibold text-[#2C2C2C] text-center px-2 py-3 mb-4">
            ...
            <div key={discount._id} className="border rounded-lg p-4 shadow-md">
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  ...
                  <div>
                    <span className="text-sm font-semibold mt-2">
                    Total de ventas en pesos: </span><span className="text-sm text-gray-600 mt-2"> $ {discount.salesValue}
                    </span>
                  </div>
                </div>
              </div>
