  ...
  return (
    <div className="flex flex-col w-full mt-3">
      <span className="flex justify-between text-sm font-normal text-[#FD7B03] pb-1">
        <label htmlFor={name} className="text-sm ml-[15px] font-medium text-black">{label}</label>
        {extra}
      </span>
      <input
        id={name}
      ...
      {type === "file" ? (
        ...
        >
          ...
          {value ? (
            ...
            <span className="border-[2px] border-gray-400 rounded-lg px-4 py-1 hover:bg-gray-600 hover:text-white cursor-pointer">Elegir archivo...</span>
          )}
        </label>
      ) : (
        <input
